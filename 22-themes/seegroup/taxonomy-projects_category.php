        ...
        <div class="container-small">
          <div class="category-list flex flex-justify-center">
            ...
            <?php foreach ($categories as $cat): ?>
              <a class="<?php if (get_queried_object()->slug == $cat->slug): echo "current"; endif; ?>" href="<?php echo get_term_link($cat->term_id); ?>" title="View <?php echo $cat->name; ?> Posts"><h6><?php echo $cat->name; ?></h6></a>
            <?php endforeach; ?>
          </div>
        </div>
      <?php endif; ?>
